...
//	{ GPIOE, { GPIO_PIN_9,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_LOW,       GPIO_AF1_TIM1	        }, GPIO_PIN_RESET},	// TIM1_CH1 (*) tim.cでインプットキャプチャ使用時に設定
	...
	{ GPIOB, { GPIO_PIN_0,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF5_SPI1	        }, GPIO_PIN_RESET},	// SPI1 NSS
	...
	{ GPIOC, { GPIO_PIN_1,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF3_SPI2	        }, GPIO_PIN_RESET},	// SPI2 NSS
	{ GPIOC, { GPIO_PIN_2,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF5_SPI2	        }, GPIO_PIN_RESET},	// SPI2 SCK
	{ GPIOB, { GPIO_PIN_12, GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF5_SPI2	        }, GPIO_PIN_RESET},	// SPI2 MISO
	{ GPIOB, { GPIO_PIN_13, GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF5_SPI2	        }, GPIO_PIN_RESET},	// SPI2 MOSI
	{ GPIOC, { GPIO_PIN_11, GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF6_SPI3	        }, GPIO_PIN_RESET},	// SPI3 NSS
