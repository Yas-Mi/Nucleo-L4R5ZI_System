...
//	{ GPIOE, { GPIO_PIN_9,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_LOW,       GPIO_AF1_TIM1	        }, GPIO_PIN_RESET},	// TIM1_CH1 (*) tim.cでインプットキャプチャ使用時に設定
	...
	{ GPIOF, { GPIO_PIN_7,  GPIO_MODE_AF_PP,     GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO2
	{ GPIOF, { GPIO_PIN_8,  GPIO_MODE_AF_PP,     GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO0
	{ GPIOF, { GPIO_PIN_9,  GPIO_MODE_AF_PP,     GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO1
	{ GPIOF, { GPIO_PIN_10, GPIO_MODE_AF_PP,     GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF3_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_CLK
	{ GPIOA, { GPIO_PIN_4,  GPIO_MODE_AF_PP,     GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF3_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_NCS
	{ GPIOE, { GPIO_PIN_15, GPIO_MODE_AF_PP,     GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO3
