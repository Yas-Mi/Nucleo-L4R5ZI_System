...
//	{ GPIOE, { GPIO_PIN_9,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_LOW,       GPIO_AF1_TIM1	        }, GPIO_PIN_RESET},	// TIM1_CH1 (*) tim.cでインプットキャプチャ使用時に設定
	...
	{ GPIOE, { GPIO_PIN_11, GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_NCS
	{ GPIOF, { GPIO_PIN_6,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO3
	{ GPIOD, { GPIO_PIN_4,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO4
	{ GPIOC, { GPIO_PIN_2,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO5
	{ GPIOD, { GPIO_PIN_6,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO6
	{ GPIOD, { GPIO_PIN_7,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF10_OCTOSPIM_P1	}, GPIO_PIN_RESET},	// OCTOSPIM_P1_IO7
...
//	{ GPIOA, { GPIO_PIN_8,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW,       0U	                    }, GPIO_PIN_RESET},	// ILI9341 RESET
	{ GPIOA, { GPIO_PIN_8,  GPIO_MODE_AF_PP,     GPIO_NOPULL, GPIO_SPEED_FREQ_LOW,       GPIO_AF0_MCO	        }, GPIO_PIN_RESET},	// MCO 15MHz
	...
	{ GPIOC, { GPIO_PIN_7,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW,       0U	                    }, GPIO_PIN_RESET},	// LD1
	{ GPIOF, { GPIO_PIN_5,  GPIO_MODE_IT_FALLING,GPIO_NOPULL, 0U,                        0U	                    }, GPIO_PIN_RESET},	// CAN INT (EXTI5)
};
