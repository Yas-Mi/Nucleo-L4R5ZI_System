...
static const PIN_FUNC_INFO pin_func[] = {
	...
	{ GPIOB, { GPIO_PIN_10, GPIO_MODE_AF_OD,     GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF4_I2C2	 }},	// I2C2 SDA
	{ GPIOB, { GPIO_PIN_11, GPIO_MODE_AF_OD,     GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF4_I2C2	 }},	// I2C2 SCL
