...
extern int32_t w25q20ew_cmd_write(uint32_t addr, uint8_t *data, uint8_t size);
extern int32_t w25q20ew_cmd_erase(uint32_t addr);
extern int32_t w25q20ew_cmd_wait_wr_proc(uint32_t timeout);
extern int32_t w25q20ew_cmd_read(uint32_t addr, uint8_t *data, uint8_t size);
extern int32_t w25q20ew_cmd_read_status(uint8_t *data);
